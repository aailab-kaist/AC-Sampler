"""Discriminator utilities (from the DG code base, Kim et al., 2023).

The discriminator operates on features of a frozen, noise-conditioned ADM
classifier. Its output logit approximates log p_real(x_t) / p_gen(x_t).
"""
